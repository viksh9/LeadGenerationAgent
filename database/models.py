"""SQLAlchemy models. Lead is the canonical persisted prospect record."""
...
class Lead(Base):
    """Denormalized lead row used by scoring, enrichment, and outreach."""
    ...
    signal_type: Mapped[str | None] = mapped_column(String(64), index=True, nullable=True)
    ...
    hiring_roles: Mapped[list[str] | None] = mapped_column(JSON, default=list)
    ...
    lead_priority: Mapped[str] = mapped_column(String(32), default=LeadPriority.LOW.value, index=True)
