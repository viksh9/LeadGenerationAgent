...
export function CallTalkingPoints({ item }: { item: OutreachItem }) {
  ...
  if (points.length === 0) {
    return <p className="text-sm text-slate-400">No call talking points have been generated.</p>;
  }
  return (
    <div>
      <div className="mb-1 flex items-center justify-between">
        <p className="text-xs font-medium uppercase tracking-wide text-slate-400">Talking points</p>
