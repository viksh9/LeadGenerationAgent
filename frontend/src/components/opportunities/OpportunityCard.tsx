  ...
  return (
    ...
    >
      ...
      <dl className="mt-3 grid grid-cols-2 gap-2 text-xs">
        <div>
          <dt className="text-slate-400">Estimated team</dt>
        ...
        <div>
          ...
          <dd className="text-slate-700">{o.status}</dd>
        </div>
      </dl>
      ...
      {o.recommendedAction && (
        <p className="mt-3 line-clamp-2 text-xs text-slate-500">{o.recommendedAction}</p>
      )}
    </button>
  );
}
