"""Deterministic, keyword/rule-based signal detection.

``SignalDetector`` turns raw lead text/fields into a structured
``SignalDetectionResult``. No LLM, no network, no database access.
"""
